...
func TestDurationUnmarshalJSON(t *testing.T) {
	cappedTimeDiff1, _ := time.ParseDuration("7446h7m8.000000000s")
	cappedNegTimeDiff1, _ := time.ParseDuration("-7446h7m8.000000000s")
