// Package time provides time types with the JSON marshalling that the Anchore
// Enterprise integration APIs expect: timestamps as RFC3339 strings and
// durations as a bare number of seconds.
package time
